...
export function HeroSection({ onStartBuilding }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden py-24 sm:py-32 min-h-[500px]">
      <img src={heroImage} alt="Elderly woman smiling while using a smartphone" className="absolute inset-0 w-full h-full object-cover object-right sm:object-center" />
